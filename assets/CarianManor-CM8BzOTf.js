import{_ as p,N as b}from"./OuterLeagueLogo-Bq_WKjt0.js";import{d as C,T as w}from"./marked.esm-Cupjb65a.js";import{_ as m,c as h,o as g,a as s,b as _,d as y,e as f,f as u,g as c}from"./index-B2-VNebP.js";const v={name:"CarianManorRules",setup(){const i=`
...
- Completing Carian Manor means to get to and Defeat the Loretta Replacement Hitless using a Fresh New Character, You are allowed to Quit Out when you see "RUN COMPLETED" (This Text Replaces the "Enemy Felled" Text)
    ...
    `,e=_("");function l(n){return n.replace(/<t:(\d+)(?::([a-zA-Z]))?>/g,(t,o,d)=>{const a=new Date(parseInt(o,10)*1e3);switch(d){case"t":return a.toLocaleTimeString();case"T":return a.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",second:"2-digit"});case"d":return a.toLocaleDateString();case"D":return a.toLocaleDateString([],{year:"numeric",month:"long",day:"numeric"});case"f":return a.toLocaleString([],{dateStyle:"long",timeStyle:"short"});case"F":return a.toLocaleString([],{dateStyle:"full",timeStyle:"long"});case"R":return r(a);default:return a.toLocaleString()}})}function r(n){const t=(n.getTime()-Date.now())/1e3,o=new Intl.RelativeTimeFormat("en",{numeric:"auto"});return Math.abs(t)<60?o.format(Math.round(t),"seconds"):Math.abs(t)<3600?o.format(Math.round(t/60),"minutes"):Math.abs(t)<86400?o.format(Math.round(t/3600),"hours"):o.format(Math.round(t/86400),"days")}return y(()=>{const n=l(i);e.value=C.parse(n)}),{parsedText:e}}},M={class:"rules-container"},S=["innerHTML"];function T(i,e,l,r,n,t){return g(),h("div",M,[s("div",{innerHTML:r.parsedText},null,8,S)])}const F=m(v,[["render",T],["__scopeId","data-v-67afa7c8"]]),E=f({name:"GithubDownloadCard",methods:{openGithub(){window.open("https://github.com/ignitesouls/Outer-League/releases/tag/Carian-Manor","_blank")}}}),R={class:"card"};function D(i,e,l,r,n,t){return g(),h("div",R,[e[1]||(e[1]=s("h2",{class:"title"},"Carian Manor",-1)),e[2]||(e[2]=s("p",{class:"description"},"Click below to download the latest version from GitHub.",-1)),s("button",{onClick:e[0]||(e[0]=(...o)=>i.openGithub&&i.openGithub(...o)),class:"download-btn"}," Download from GitHub ")])}const $=m(E,[["render",D],["__scopeId","data-v-47f7884a"]]),G=f({name:"CarianManor",components:{Navigation:b,Table:w,Info:F,Download:$}}),H={class:"page-container"},L={class:"main-container"};function k(i,e,l,r,n,t){const o=c("Navigation"),d=c("Info"),a=c("Download");return g(),h("div",H,[u(o),s("div",L,[e[0]||(e[0]=s("div",{class:"top-image-container"},[s("img",{src:p,class:"logo"})],-1)),u(d),u(a)])])}const O=m(G,[["render",k],["__scopeId","data-v-805f42cf"]]);export{O as default};
